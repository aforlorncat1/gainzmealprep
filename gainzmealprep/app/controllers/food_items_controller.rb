class FoodItemsController < ApplicationController
  ...
  def show
    ...
    @cart_action = @food_item.cart_action current_user.try :id
  end
  ...
  private
    ...
    def food_item_params
      params.require(:food_item).permit(:name, :description, :calories, :carbs, :protein, :fat, :price, :category, :secondary_ingredient, :secondary_ingredient_type)
    end
end
